...
namespace LLM.StudyZone.Web.Public.Menus;

public class StudyZonePublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public StudyZonePublicMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<StudyZoneResource>();

        // Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                StudyZonePublicMenus.HomePage,
                l["Menu:HomePage"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                StudyZonePublicMenus.ArticleSample,
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                StudyZonePublicMenus.ContactUs,
                l["Menu:ContactUs"],
                "~/contact-us",
                icon: "fa fa-phone",
                order: 3
