...
```
127.0.0.1 studyzone-local-web
127.0.0.1 studyzone-local-webgateway
127.0.0.1 studyzone-local-authserver
```
...
Now, you can browse the URL: `https://studyzone-local-web`
